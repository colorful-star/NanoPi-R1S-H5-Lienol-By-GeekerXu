...
[ -f configs/config_rk3328 ] && echo -e '\nCONFIG_KERNEL_BUILD_USER="GeekerXU"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by GeekerXU"' >> configs/config_rk3328
[ -f configs/config_h5 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="GeekerXU"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by GeekerXU"' >> configs/config_h5
